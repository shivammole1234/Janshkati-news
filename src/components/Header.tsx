        ...
        <div className="max-w-[1280px] mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <span className="flex items-center">
              ...
              <span>Mumbai, India • 28°C • Rain Alert</span>
            </span>
          </div>
          ...
          >
            ...
            <div className="relative w-full flex flex-col items-center">
              ...
              {currentLanguage === 'english' ? (
                <span className="text-3xl md:text-4xl lg:text-5xl font-serif font-black text-brand-red tracking-tight pt-1 leading-none">
                  Janshakti
                </span>
              ) : (
                <span className="text-3xl md:text-4xl lg:text-5xl font-devanagari font-black text-brand-red tracking-wider pt-1.5 leading-none">
